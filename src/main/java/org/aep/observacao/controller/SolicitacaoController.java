...
public class SolicitacaoController {
    ...
    @PostMapping
    public ResponseEntity<Solicitacao> criarSolicitacao(@RequestBody CriarSolicitacaoRequest request) {
    ...
    public List<Solicitacao> listarSolicitacoes(
        ...
        return servicoSolicitacoes.listarSolicitacoes(prioridade, bairro, categoria);
    }
    ...
    public List<HistoricoStatus> historico(@PathVariable int id) {
        return servicoSolicitacoes.getHistorico(id);
    }

    @PatchMapping("/{id}/status")
    public ResponseEntity<Void> atualizarStatus(@PathVariable int id, @RequestBody AtualizarStatusRequest request) {
    ...
    public record UsuarioRequest(Integer id, String nome, String email, String telefone) {
    }

    public record AtualizarStatusRequest(Status status, String responsavel, String comentario) {
    }
}